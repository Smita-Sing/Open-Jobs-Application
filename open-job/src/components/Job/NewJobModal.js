...
export default (props) => {
    ...
    const skills = [
        "Javascript", "React", "Node", "Vue", "Firebase", "MongoDB", "SQL", "Python"];
        ...
        <Dialog open= {props.newJobModal} fullWidth>
            ...
            <DialogContent>
                <Grid container spacing= {2}>
                    ...
                    <Grid item xs = {6}>
                        <Select onChange = {handleChange} fullWidth name = "type" value = {jobDetails.type}  disableUnderline variant= "filled">
                    ...
                    <Grid item xs = {6}>
                    <Select onChange = {handleChange}  fullWidth  name = "location" value = {jobDetails.location} disableUnderline variant="filled" >
                ...
                <Box mt = {2}>
                    ...
                    <Box display = "flex">
                        {skills.map((skill) => (
                            <Box onClick = {() => addRemoveSkill(skill)}  className = {`${classes.skillChip} ${jobDetails.skills.includes(skill) && classes.included}`} display = "flex" justifyContent = "space-between" key = {skill}>{skill}</Box>
                        ))}
                   </Box>
                </Box>
            </DialogContent>
